<template>
<div>
<p style="font-size:15px" class="font-black">해결키워드적기</p>
...
export default {
  ...
  methods: {
    submitResolutionHashTags(){
      this.$emit("submitResolutionHashTags",{
        tags : this.tags,
      });
    },
    setVisible() {
  ...
  mounted() {
      this.emitter.on("submitResolution",  ()=>this.submitResolutionHashTags());
    },
  created(){
